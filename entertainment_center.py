...
duckweed = media.Movie("Duckweed",
	"When a son attempts to reconcile with his father, some fateful events allow him to experience his father's life in the past.",
	"http://t1.gstatic.com/images?q=tbn:ANd9GcSLHojDUMoCl7e_ZKzoFsn74fEEiQYCHAuAFwMJ81YR9HX7hGCb",
...
journey_to_the_west = media.Movie("Journey to the West: The Demons Strike Back",
	"A monk (Kris Wu) and his disciples encounter a spider demon and other fantastic creatures on their travels.",
	"http://t2.gstatic.com/images?q=tbn:ANd9GcSZKI9yppcEYchk4D8oBShYkD3ltmfjO6XEmb7UMlcloowdGtL0",
